...
LocalMusicBackend::LocalMusicBackend(QObject *parent, const QVariantList &args) : AbstractBrowsingBackend(parent, args),
m_fromPlaces(true),
...
QAbstractItemModel* LocalMusicBackend::model()
{
    if (!m_model) {
...
void LocalMusicBackend::createConfigurationInterface(KConfigDialog *parent)
{
...
void LocalMusicBackend::configAccepted()
{
...
void LocalMusicBackend::setFolderNavigation()
{
